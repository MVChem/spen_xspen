...
Provenance is the external [legacy demo directory](/home/data2/chk/workspace/2026/08/14/01_工作项目/spen_recons/spenpy/demo/), specifically `09_hand_by_hand_phase_map.ipynb` and `19_spen_original_tinyphase_inva.ipynb`. Their filenames remain in regression tests and source notes, not in public method names.
