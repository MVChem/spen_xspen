...
The notebook integration tests load their original source and MAT input from the external legacy [spen_recons repository](/home/data2/chk/workspace/2026/08/14/01_工作项目/spen_recons/). They skip if those external reference files are absent. No generated plot or fitted traditional reconstruction is used as a calibration target.
